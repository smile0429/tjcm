...
var AppJS = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('.page-sidebar').on('click', ' li > a.ajaxify', function (e) {
                ...
                AppJS.blockUI(pageContent, false);

                $.post(url, {}, function (res) {
                        AppJS.unblockUI(pageContent);
                        pageContentBody.html(res);
                        AppJS.fixContentHeight(); // fix content height
                        AppJS.initUniform(); // initialize uniform elements
                    });
            });
    }
    ...
    var handleFixedSidebar = function () {
        ...
        if (menu.parent('.slimScrollDiv')!='' && menu.parent('.slimScrollDiv').length != 0) { // destroy existing instance before updating the height
            menu.slimScroll({
                destroy: true
            });
    ...
    var handleTooltips = function () {
        if (AppJS.isTouchDevice()) { // if touch device, some tooltips can be skipped in order to not conflict with click events
    ...
    return {
        ...
        init: function () {
            ...
            AppJS.addResponsiveHandler(handleChoosenSelect); // reinitiate chosen dropdown on main content resize. disable this line if you don't really use chosen dropdowns.
        },
